...
const { userInfo, roomId, peopleNum, checkInDate, checkOutDate, orderUserId } =
	orderData.value;
...
const stayDuration = timeDifference / (1000 * 3600 * 24);
...
const description =
	'讓高雄享樂酒店的舒適房型陪伴您的旅行，無論是家庭度假還是商務會議，我們都為您提供最貼心的服務與設施。';
				...
				<div class="col-12 col-md-5">
					...
					>
						...
						<section>
							...
							>
								<li
									v-for="item in roomId.facilityInfo"
									:key="item.title"
						...
						<section>
							...
							>
								<li
									v-for="item in roomId.amenityInfo"
									:key="item.title"
									class="flex-item d-flex gap-2"
								>
									<Icon
